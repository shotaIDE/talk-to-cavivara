...
int _userEstimateSize(
  ...
  bytesCount += 3 + object.householdIds.length * 3;
  {
    for (var i = 0; i < object.householdIds.length; i++) {
      final value = object.householdIds[i];
...
void _userSerialize(
  ...
  writer.writeStringList(offsets[2], object.householdIds);
...
User _userDeserialize(
  ...
  final object = User(
    ...
    householdIds: reader.readStringList(offsets[2]) ?? [],
    isPremium: reader.readBoolOrNull(offsets[3]) ?? false,
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'householdIds',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<User, User, QAfterFilterCondition>
      householdIdsElementGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsElementLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsElementBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsElementContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsElementMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsElementIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'householdIds',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'householdIds',
        0,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'householdIds',
        0,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> householdIdsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByHouseholdIds() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'householdIds');
    });
  }
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, List<String>, QQueryOperations> householdIdsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'householdIds');
    });
  }
