...
現在、アプリは完全無料で提供されているが、継続的な開発・運営コスト（サーバー費用、AI API費用など）をサポートする仕組みが必要である。機能制限による課金ではなく、「応援」という形での課金により、ユーザーとの良好な関係を維持しつつ収益化を図る。
...
- 6つの金額プランから選択できる（¥120, ¥370, ¥610, ¥1,220, ¥3,060, ¥6,100）
...
- `support_1220`, `support_3060`, `support_6100`

※実際のバンドルID/パッケージ名のプレフィックスを追加
